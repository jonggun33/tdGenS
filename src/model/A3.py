...
class A3(BaseModel):
    Header: A3Header = Field(..., description="A3 Header Information")
    DataS: list[A3Data] = Field(..., description="List of A3 Data Records")
    def to_xml(self):
        return json_to_xml(self.model_dump(), root_name="TransactionRequest")

if __name__ == "__main__":
    a3_example = A3(
        Header=A3Header(TransactionId=123456),
        DataS=[
            A3Data(
                MaterialCode="MAT001",
                ControlNo="CTRL001",
